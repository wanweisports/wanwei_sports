...
import com.park.message.model.Article;
import com.park.message.model.Music;
import com.park.pojo.SNSUserInfo;
import com.park.pojo.WeixinGroup;
import com.park.pojo.WeixinMedia;
import com.park.pojo.WeixinOauth2Token;
import com.park.pojo.WeixinQRCode;
import com.park.pojo.WeixinUserInfo;
import com.park.pojo.WeixinUserList;
...
public class AdvancedUtil {
	...
	public static void main(String args[]) {
		// 获取接口访问凭证
		String accessToken = CommonUtil.getToken("wx8fd1e45f0ffe1389",
				"f27d837b9c4cbf04578530d997302a02").getAccessToken();
		...
		*/ 
		...
		String jsonTextMsg = makeTextCustomMessage(
				"otWXBt3Clu58weJi01BnBNdV14C8", "测试发送客服消息");
		// 发送客服消息
		...
		*/ 
		...
		String jsonNewsMsg = makeNewsCustomMessage(
				"otWXBt3Clu58weJi01BnBNdV14C8", list);
		// 发送客服消息
		...
		*/ 
		 ...
		 * 移动用户分组
		 */
		updateMemberGroup(accessToken, "otWXBt3Clu58weJi01BnBNdV14C8", 100);

		/**
		 * 上传多媒体文件
		 
		WeixinMedia weixinMedia = uploadMedia(accessToken, "voice",
				"http://localhost:8080/upload/test.mp3");
