 ...
 */
@Entity
@Table(name="other_balance"
    ,catalog="park"
, uniqueConstraints = @UniqueConstraint(columnNames="balanceNo")
)
...
public class OtherBalance  implements java.io.Serializable {
	...
	/** minimal constructor */
    public OtherBalance(String balanceNo, String balanceServiceType, Integer balanceServiceId) {
    ...
    /** full constructor */
    public OtherBalance(String balanceNo, String balanceServiceType, Integer balanceServiceId, String balanceServiceName, String balanceType, String balanceStyle, String balanceCheckNo, Double oldAmount, Double realAmount, Double subAmount, Double givingAmount, Double divBalance, String balanceStatus, String serviceDate, Double changeAmount, String createTime, String updateTime, Integer salesId, String remark, Integer balanceCardId) {
        this.balanceNo = balanceNo;
        this.balanceServiceType = balanceServiceType;
        this.balanceServiceId = balanceServiceId;
