...
<layout:override name="<%=Blocks.BLOCK_NAV_PATH%>">
    当前位置: <span>学生管理</span> &gt;&gt; <span>学生注册</span>
</layout:override>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label for="student_class" class="col-sm-4 control-label">
                                <span class="text-danger">*</span> 所在班级
                            </label>

                            <div class="col-sm-8">
                                <select class="form-control" id="student_class" name="studentClass"
                                        data-val="true" data-val-required="请选择所在班级">
                        ...
                        <div class="form-group">
                            <label for="quick_name" class="col-sm-4 control-label">
                                <span class="text-danger">*</span> 联系人
                            </label>

                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="quick_name" name="quickName"
                                       placeholder="请输入紧急联系人" autocomplete="off"
                                       data-val="true" data-val-required="紧急联系人不能为空">
                                <div data-valmsg-for="quickName" data-valmsg-replace="true"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-4 col-sm-8">
                                <button type="button" class="btn btn-primary col-sm-4 register-student">
                                    <span class="glyphicon glyphicon-ok"></span>  注 册
                                </button>
                            </div>
                        </div>
                    </div>
