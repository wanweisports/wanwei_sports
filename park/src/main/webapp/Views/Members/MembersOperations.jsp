...
<layout:override name="<%=Blocks.BLOCK_HEADER_SCRIPTS%>">
    ...
    <script src="/Content/app/members/members_card_operations.js?v=${static_resource_version}"></script>
    <script>
        // 表单校验配置
...
<layout:override name="<%=Blocks.BLOCK_NAV_PATH%>">
    当前位置: <span>会员管理</span> &gt;&gt; <span>会员操作</span>
</layout:override>

<layout:override name="<%=Blocks.BLOCK_BODY%>">
    <div class="container-fluid" style="text-align: left;">
        <div class="panel panel-default member-card-panel">
            <div class="panel-heading">会员操作</div>
