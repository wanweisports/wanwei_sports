...
<layout:override name="<%=Blocks.BLOCK_HEADER_SCRIPTS%>">
    ...
    <script src="/Content/app/members/members_consume_list.js?v=${static_resource_version}"></script>
    <script>
        //$("#status").val('${status}');
    </script>
</layout:override>
...
<layout:override name="<%=Blocks.BLOCK_NAV_PATH%>">
    当前位置: <span>会员管理</span> &gt;&gt; <span>会员查询</span> &gt;&gt; <span>会员详情</span> &gt;&gt; <span style="color: #f00;">消费明细[未完成]</span>
</layout:override>
    ...
    <div class="container-fluid" style="text-align: left;">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-inline" id="consume_filter_form" onsubmit="return false;">
                    <input type="hidden" name="cardId" value="${cardId}">
                    <div class="form-group">
                        <select class="form-control" id="status" name="status" style="width: 160px;">
                            <option>全部类型</option>
                            <option>场地消费</option>
                            <option>商品消费</option>
                        </select>
                    ...
                    <div class="form-group pull-right">
                        <a href="/member/getBalances?cardId=${cardId}" class="btn btn-primary">
                            <span class="glyphicon glyphicon-th-list"></span> 储值明细
                        </a>
                    </div>
                </form>
            </div>
