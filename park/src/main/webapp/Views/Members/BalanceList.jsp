...
<layout:override name="<%=Blocks.BLOCK_HEADER_SCRIPTS%>">
    ...
    <script src="/Content/dist/members/members_balance_list.js?v=${static_resource_version}"></script>
</layout:override>
                    ...
                    <form class="form-inline" id="balance_filter_form" onsubmit="return false;">
                        ...
                        <div class="form-group">
                            <div class="input-group date form_datetime">
                                <input type="text" class="form-control" name="createTimeStart" placeholder="开始时间"
                                       readonly value="${createTimeStart}">
                        ...
                        <div class="form-group">
                            <div class="input-group date form_datetime">
                                <input type="text" class="form-control" name="createTimeEnd" placeholder="结束时间"
                                       readonly value="${createTimeEnd}">
                                <span class="input-group-addon">
                                    <i class="glyphicon glyphicon-calendar"></i>
                                </span>
                            </div>
