        ...
        <tr>
            <td class="navigator-list">
                <table class="list">
                    ...
                    <tr class="list-nav-header active" data-item="member">
                        <td>
                    ...
                    <tr class="list-nav-item site ${param.subNav == "sequence" ? "active" : ""}" style="display: none;">
                        <td>
                            <span><a href="/site/getSiteReservationInfo">场地预订</a></span>
                        </td>
                    </tr>
                    <tr class="list-nav-item site" style="display: none;">
                        <td>
                    ...
                    <tr class="list-nav-item site last-nav-item" style="display: none;">
                        <td>&nbsp;</td>
                    </tr>
                    ...
                    <tr class="list-nav-item good ${param.subNav == "setting" ? "active" : ""}" style="display: none;">
                        <td>
                            <span><a href="/good/updateGood">商品设置</a></span>
                        </td>
                    </tr>
                    <tr class="list-nav-item good ${param.subNav == "stock" ? "active" : ""}" style="display: none;">
                        <td>
                            <span><a href="/good/getGoods">进销存管理</a></span>
                        </td>
                    </tr>
                    <tr class="list-nav-item good ${param.subNav == "market" ? "active" : ""}" style="display: none;">
                        <td>
                            <span><a href="/good/getGoodsMarket">商品销售</a></span>
                        </td>
                    </tr>
                    <tr class="list-nav-item good ${param.subNav == "order" ? "active" : ""}" style="display: none;">
                        <td>
                            <span><a href="#">商品订单</a></span>
                        </td>
                    </tr>
                    <tr class="list-nav-item good last-nav-item" style="display: none;">
                        <td>&nbsp;</td>
                    </tr>
                    ...
                    <tr class="list-nav-item data" style="display: none;">
                        <td>
                    ...
                    <tr class="list-nav-item data last-nav-item" style="display: none;">
                        <td>&nbsp;</td>
                    </tr>
                    ...
                    <tr class="list-nav-item setting" style="display: none;">
                        <td>
                    ...
                    <tr class="list-nav-item setting last-nav-item" style="display: none;">
                        <td>&nbsp;</td>
                    </tr>
                </table>
            </td>
