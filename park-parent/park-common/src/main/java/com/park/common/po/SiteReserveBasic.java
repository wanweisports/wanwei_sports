...
public class SiteReserveBasic implements java.io.Serializable {
	...
	@Transient
	private List<com.park.common.po.SiteReserveDate> siteReserveDateList;
	...
	@Transient
	public List<com.park.common.po.SiteReserveDate> getSiteReserveDateList() {
		return siteReserveDateList;
	}

	@Transient
	public void setSiteReserveDateList(List<com.park.common.po.SiteReserveDate> siteReserveDateList) {
