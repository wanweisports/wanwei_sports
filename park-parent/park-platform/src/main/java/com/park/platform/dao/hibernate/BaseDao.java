package com.park.platform.dao.hibernate;
...
public class BaseDao extends HibernateDaoSupport implements IBaseDao {
    ...
    public Number getUniqueResult(final String sql){
        return super.getHibernateTemplate().execute(new HibernateCallback<Number>() {
            ...
            @Override
            public Number doInHibernate(Session s) throws HibernateException, SQLException {
    ...
    public int delete(final String tableName, final String idName, final Integer id) {
        return getHibernateTemplate().execute(new org.springframework.orm.hibernate3.HibernateCallback<Integer>() {
