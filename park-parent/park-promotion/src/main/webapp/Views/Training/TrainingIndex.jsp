            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li><a class="J_menuItem" href="/training/settings/course">课程设置</a></li>
                        <li><a class="J_menuItem" href="/training/settings/backup">备份恢复数据库</a></li>
                        <li><a class="J_menuItem" href="/training/settings/operators">操作员设置</a></li>
                        <li><a class="J_menuItem" href="/training/settings/others">其它设置</a></li>
                    </ul>
                </li>
                <li class="line dk"></li>
