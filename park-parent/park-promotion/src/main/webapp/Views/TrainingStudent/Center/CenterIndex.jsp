        ...
        <div id="webModuleContainer" class="webModuleContainer" style="overflow: hidden;">
            <div id="module311" class="form Handle formStyle6">
                <div class="textImg3" style="height: 7rem; background: #0657a9;">
                    <img src="/Content/images/training/student/teacher4.jpg"
                         style="width: 5rem; height: 5rem; margin-top: 1rem; float: left; margin-left: .4rem; border-radius: 2.5rem;">
            ...
            <div class="">
                <input type="button" class="g_button sendIcon" value="退出登录">
            </div>
        </div>
    </div>
