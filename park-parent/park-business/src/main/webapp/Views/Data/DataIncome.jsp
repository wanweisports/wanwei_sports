...
<layout:override name="<%=Blocks.BLOCK_HEADER_CSS%>">
    <link href="Content/style/data/data_income.css?v=${static_resource_version}" rel="stylesheet" type="text/css">
</layout:override>
    ...
    <div id="main" class="container">
        <div class="weui-form-preview">
            <div class="weui-form-preview__bd" style="position: relative;">
                <div style="position: absolute; width: 100%; height: 100%; z-index: 1; top: 0; left: 0;"></div>
                <table>
                    <thead>
                    <tr>
                        <th>会员</th>
            ...
            <div class="weui-form-preview__ft">
                ...
                <a class="weui-form-preview__btn weui-form-preview__btn_primary" href="/data/incomeCompare">历史数据对比</a>
            </div>
        </div>
    </div>
</layout:override>
