...
<layout:override name="<%=Blocks.BLOCK_HEADER_CSS%>">
    <link href="Content/style/dashboard/dashboard.css?v=${static_resource_version}" rel="stylesheet" type="text/css">
</layout:override>
