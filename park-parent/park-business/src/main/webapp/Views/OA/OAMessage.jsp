...
<layout:override name="<%=Blocks.BLOCK_HEADER_CSS%>">
    <link href="Content/style/oa/oa_notifications_detail.css?v=${static_resource_version}" rel="stylesheet" type="text/css">
</layout:override>
    ...
    <div id="main" class="container">
        <div class="weui-tab">
            <div class="weui-navbar">
                <a href="/oa/getMessage?type=3" data-type="3" class="weui-navbar__item note-type weui-bar__item_on">全部</a>
                <a href="/oa/getMessage?type=31" data-type="31" class="weui-navbar__item note-type">未读</a>
                <a href="/oa/getMessage?type=32" data-type="32" class="weui-navbar__item note-type">已读</a>
                <a href="/oa/getMessage?type=4" data-type="4" class="weui-navbar__item note-type">已删</a>
            </div>
                    ...
                    <div class="weui-form-preview">
                        ...
                        <div class="weui-form-preview__ft">
                            ...
                            <a class="weui-form-preview__btn weui-form-preview__btn_primary" data-note="${note.noteId}"
                               data-id="${note.id}" href="/oa/notificationsDetail?noteId=${note.noteId}">查看消息</a>
                        </div>
                    </div>
                </c:forEach>
