...
<layout:override name="<%=Blocks.BLOCK_HEADER_SCRIPTS%>">
    <script src="Content/app/center/center_profile.js?v=${static_resource_version}"></script>
</layout:override>

<layout:override name="<%=Blocks.BLOCK_BODY%>">
    <div id="main" class="container">
        <div class="weui-cells__title">个人信息</div>
        <form id="center_form" class="weui-cells weui-cells_form" onsubmit="return false;" novalidate>
            <div class="weui-cell">
            ...
            <div class="weui-cell">
                ...
                <div class="weui-cell__bd">
                    <input class="weui-input" name="operatorAddress" type="text" placeholder="联系地址"
                           value="${operatorAddress}" autocomplete="off">
                </div>
            </div>
        </form>

        <div class="weui-btn-area">
            <a class="weui-btn weui-btn_primary profile-submit" href="javascript:;">保存修改</a>
        </div>
    </div>
</layout:override>
