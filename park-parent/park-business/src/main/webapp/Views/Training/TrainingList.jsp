...
<layout:override name="<%=Blocks.BLOCK_HEADER_SCRIPTS%>">
    <script src="Content/app/training/training_class.js?v=${static_resource_version}"></script>
    <script>
            ...
            <div class="weui-tab__panel">
                <c:if test="${fn:length(list) == 0}">
                    ...
                    <div class="weui-btn-area">
                        <a class="weui-btn weui-btn_primary" href="/training/create">直接创建班级</a>
                ...
                <c:if test="${fn:length(list) > 0}">
                    <div class="weui-flex class-buttons">
                        ...
                        <div class="weui-flex__item">
                            <div class="class-btn">
                                <a class="weui-btn weui-btn_primary" href="/training/create">创建班级</a>
                            </div>
                        </div>
                    </div>
                </c:if>
                ...
                <c:forEach var="item" items="${list}">
                    <div class="weui-panel weui-panel_access">
                        <div class="weui-panel__bd">
                            <a href="/training/students?classId=${item.id}" class="weui-media-box weui-media-box_appmsg">
                        ...
                        <div class="weui-panel__ft">
                            <a href="/training/students?classId=${item.id}" class="weui-cell weui-cell_access weui-cell_link">
                                <c:if test="${item.unSignClass == 1}">
