        ...
        <div class="weui-msg">
            ...
            <div class="weui-msg__opr-area">
                <p class="weui-btn-area">
                    <a href="<%=basePath%>mobile/reservation/orders" class="weui-btn weui-btn_primary">我的订单</a>
                    <a href="<%=basePath%>mobile/dashboard" class="weui-btn weui-btn_default">返回首页</a>
                </p>
            </div>
        </div>
