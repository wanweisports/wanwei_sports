...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="Content/style/training/fontsIco.min.css?v=${static_resource_version}">
    <link rel="stylesheet" type="text/css"
          href="Content/style/training/base.css?v=${static_resource_version}">
    <link rel="stylesheet" type="text/css"
          href="Content/style/training/style.css?v=${static_resource_version}">
