            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <form id="reservations_user_form" class="form-horizontal clearfix" novalidate onsubmit="return false;">
                            ...
                            <form id="reservations_paid_form" class="form-horizontal clearfix" novalidate onsubmit="return false;">
